...
export const creatorConfig: CreatorConfig = {
  ...
  skills: [
    ...
    "SQL",
    "NoSQL (e.g., MongoDB)",
    "ORMs (e.g., Mongoose, Prisma, Drizzle)",
    "Data modeling",
